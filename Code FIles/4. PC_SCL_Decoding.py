...
def decode(L, node, depth, SCL_N):
    ...
    left_child_decisions = decode(left_child_beliefs, 2*node, depth-1, SCL_N)
    ...
    for lch_decision in left_child_decisions:
        ...
        right_child_decisions = decode(right_child_beliefs, 2*node + 1, depth-1, SCL_N)
